...
public class JdbcUtils {
    ...
    public static Long rowsOfTable(String tableName, JdbcConfig jdbcConfig){
    ...
    public static Long upperBoundOfColumn(String columnName, String tableName, JdbcConfig jdbcConfig){
        JdbcTemplate jdbcTemplate = new JdbcTemplate(createDriverManagerDataSource(jdbcConfig));
